...
# Get init and data stored in LogisticRegression class
def test_LogisticRegression_init():
...
def test_LogisticRegression_dtype():
    """
...
def test_LogisticRegression_train():
    """
...
def test_LogisticRegression_test():
    """
